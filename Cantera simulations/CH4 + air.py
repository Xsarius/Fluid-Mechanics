...
b = 2   # coeff dependend on fuel ; b = <num of C> * 1 + <num of H> * 1/4 - <num of O> * 1/2
M_fuel = 0.01604 
rho_fuel = 0.657
flammabillityRange = [0.044,0.17] # volumetric flammabillity range
...
for p in range(1,21):
    ...
    if round(fuelMoleFrac,2) > molarFlammabillityRange[0] and round(fuelMoleFrac,2) < molarFlammabillityRange[1]:
        q = 'CH4:'+ str(equivalenceRatio) +' O2:'+ str(b) +' N2:' + str(b * 3.76)
